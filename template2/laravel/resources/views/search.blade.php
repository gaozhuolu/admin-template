    ...
    <div class="row">
       <div class="col-lg-9">
          ...
          <div class="panel panel-default">
             <div class="panel-heading">Search Results
                <a href="#" data-perform="panel-refresh" data-toggle="tooltip" title="Refresh Results" class="pull-right">
                         ...
                         <td>
                            <div class="media">
                               <a href="#" class="pull-left">
                                  <img src="assets/img/dummy.png" alt="" class="media-object img-responsive img-rounded thumb64" />
                               </a>
                      ...
                      <tr>
                         ...
                         <td>
                            <div class="media">
                               ...
                               <div class="media-body">
                                  <div class="pull-right btn btn-info btn-sm">View</div>
                                  <h4 class="media-heading">Product 4</h4>
                                  <small class="text-muted">Category1, Category2</small>
                                  <p>Sed gravida auctor odio. Sed viverra rutrum hendrerit. Praesent dapibus justo dolor. Suspendisse rhoncus consectetur eros vehicula accumsan.</p>
                               </div>
                            </div>
                      ...
                      <tr>
                         ...
                         <td>
                            <div class="media">
                               ...
                               <div class="media-body">
                                  <div class="pull-right btn btn-info btn-sm">View</div>
                                  <h4 class="media-heading">Product 5</h4>
                                  <small class="text-muted">Category1, Category2</small>
                                  <p>Sed gravida auctor odio. Sed viverra rutrum hendrerit. Praesent dapibus justo dolor. Suspendisse rhoncus consectetur eros vehicula accumsan.</p>
                               </div>
                            </div>
       ...
       <div class="col-lg-3">
          ...
          <div class="form-group mb-xl">
             ...
             <br/>
             <input id="sl2" type="text" value="" data-slider-min="10" data-slider-max="1000" data-slider-step="5" data-slider-value="[250,750]" class="slider slider-lg form-control" />
          </div>
