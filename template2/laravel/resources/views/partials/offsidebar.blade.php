        ...
        <ul class="nav">
            ...
            <li>
                ...
                <a href="#" class="media p mt0">
                    ...
                    <span class="pull-left">
                        <!-- Contact avatar-->
                        <img src="assets/img/user/07.jpg" alt="Image" class="media-object img-circle thumb32">
                    </span>
                    <!-- Contact info-->
                    <span class="media-body">
                        <span class="media-heading">
                ...
                <a href="#" class="media p mt0">
                    ...
                    <span class="pull-left">
                        <!-- Contact avatar-->
                        <img src="assets/img/user/08.jpg" alt="Image" class="media-object img-circle thumb32">
                    </span>
                    <!-- Contact info-->
                    <span class="media-body">
                        <span class="media-heading">
            ...
            <li>
                ...
                <a href="#" class="media p mt0">
                    ...
                    <span class="pull-left">
                        <!-- Contact avatar-->
                        <img src="assets/img/user/09.jpg" alt="Image" class="media-object img-circle thumb32">
                    </span>
                    <!-- Contact info-->
                    <span class="media-body">
                        <span class="media-heading">
                ...
                <a href="#" class="media p mt0">
                    ...
                    <span class="pull-left">
                        <!-- Contact avatar-->
                        <img src="assets/img/user/10.jpg" alt="Image" class="media-object img-circle thumb32">
                    </span>
                    <!-- Contact info-->
                    <span class="media-body">
                        <span class="media-heading">
