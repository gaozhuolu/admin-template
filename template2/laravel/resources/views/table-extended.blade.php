          ...
          <table id="table-ext-1" class="table table-bordered table-hover">
             ...
             <tbody>
                <tr>
                   ...
                   <td>
                      <div class="media">
                         <img src="assets/img/user/01.jpg" alt="Image" class="img-responsive img-circle" />
                      </div>
                   </td>
                   <td>@twitter</td>
                   <td>Larry</td>
                ...
                <tr>
                   ...
                   <td>
                      <div class="media">
                         <img src="assets/img/user/02.jpg" alt="Image" class="img-responsive img-circle" />
                      </div>
                   </td>
                   <td>@mdo</td>
                   <td>Mark</td>
                ...
                <tr>
                   ...
                   <td>
                      <div class="media">
                         <img src="assets/img/user/03.jpg" alt="Image" class="img-responsive img-circle" />
                      </div>
                   </td>
                   <td>@fat</td>
                   <td>Jacob</td>
             ...
             <tbody>
                   ...
                   <td>
                      <div class="media">
                         <a href="#" class="pull-left">
                            <img src="assets/img/user/01.jpg" alt="" class="media-object img-responsive img-circle" />
                         </a>
                ...
                <tr>
                   ...
                   <td>
                      <div class="media">
                         <a href="#" class="pull-left">
                            <img src="assets/img/user/03.jpg" alt="" class="media-object img-responsive img-circle" />
                         </a>
                         <div class="media-body">
                ...
                <tr>
                   ...
                   <td>
                      <div class="media">
                         <a href="#" class="pull-left">
                            <img src="assets/img/user/05.jpg" alt="" class="media-object img-responsive img-circle" />
                         </a>
                         <div class="media-body">
