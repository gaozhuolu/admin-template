...
@section('content')
    ...
    <div class="row-masonry row-masonry-md-4 row-masonry-sm-2">
       <div class="col-masonry">
          <img src="assets/img/bg1.jpg" alt="" class="img-thumbnail img-responsive" />
       </div>
       <div class="col-masonry">
          <img src="assets/img/bg4.jpg" alt="" class="img-thumbnail img-responsive" />
       </div>
       <div class="col-masonry">
          <img src="assets/img/bg2.jpg" alt="" class="img-thumbnail img-responsive" />
       </div>
       <div class="col-masonry">
          <img src="assets/img/bg5.jpg" alt="" class="img-thumbnail img-responsive" />
       </div>
       <div class="col-masonry">
          <img src="assets/img/bg6.jpg" alt="" class="img-thumbnail img-responsive" />
       </div>
       <div class="col-masonry">
          <img src="assets/img/bg7.jpg" alt="" class="img-thumbnail img-responsive" />
       </div>
       <div class="col-masonry">
          <img src="assets/img/bg8.jpg" alt="" class="img-thumbnail img-responsive" />
       </div>
       <div class="col-masonry">
          <img src="assets/img/bg9.jpg" alt="" class="img-thumbnail img-responsive" />
       </div>
       <div class="col-masonry">
          <img src="assets/img/bg10.jpg" alt="" class="img-thumbnail img-responsive" />
       </div>
    </div>
